...
import numpy as _np
_page = _Img.new("RGB", (1414, 2000), "white")
_page.paste(_Img.new("RGB", (1250, 890), (240, 240, 240)), (82, 440))
check("เนื้อหากว้างบนหน้ากระดาษแคบ → วัดจากเนื้อหา (1.4)", abs(pairing.content_ratio(_np.asarray(_page).astype(int)) - 1250 / 890) < 0.01)
_shot = _Img.new("RGB", (1080, 2400), "white")
_shot.paste(_Img.new("RGB", (1080, 2300), (250, 250, 250)), (0, 100))

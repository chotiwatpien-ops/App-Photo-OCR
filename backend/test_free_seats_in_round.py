...
# รอบอัตโนมัติกวาดเฉพาะสัปดาห์ที่ยังทำอยู่ · W36 ส่งลูกค้าไปแล้ว ไม่ต้องไปขยับ
check("สัปดาห์ที่ยังไม่จบ = เปิด", fds.week_is_open("2026-09-13", today="2026-09-13"))
check("วันสุดท้ายของสัปดาห์คือวันนี้ ก็ยังเปิด", fds.week_is_open("2026-09-13", today="2026-09-13"))
check("สัปดาห์ที่จบไปแล้ว = ปิด", not fds.week_is_open("2026-09-06", today="2026-09-13"))
check("สัปดาห์หน้า (ของที่ยกไป) ก็ยังเปิด", fds.week_is_open("2026-09-20", today="2026-09-13"))
check("ไม่รู้วันจบ ถือว่าปิด ไม่เดาแล้วไปย้ายไฟล์", not fds.week_is_open(None, today="2026-09-13"))

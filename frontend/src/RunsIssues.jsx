...
const HINTS = {
  ...
  staged: 'แถวอ่านแล้วแต่ลงโฟลเดอร์ไรเดอร์ไม่ได้ — ถ้ากลุ่มเต็ม ให้รัน workflow "Move staged" ย้ายไปกองพักสัปดาห์หน้า · ถ้าไม่มีกลุ่มรับ (ประเภทงานใหม่) แจ้งแอดมินระบบ',
